...
export HOMETEL=/home/julio/telemac-mascaret/v8p2r1
# Adding python scripts to PATH
export PATH=$HOMETEL/scripts/python3:.:$PATH
# Configuration file
export SYSTELCFG=$HOMETEL/configs/systel.cis-ubuntu20.cfg
# Name of the configuration to use
export USETELCFG=ubugapi
# Path to this file
...
export METISHOME=/home/julio/telemac-mascaret/v8p2r1/optionals/metis-5.1.0/build
